...
! function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        function h(a) {
            a.parents(".fr-img-caption").length > 0 && (a = a.parents(".fr-img-caption:first")), na(a, a.hasClass("fr-dib") ? "block" : a.hasClass("fr-dii") ? "inline" : null, a.hasClass("fr-fil") ? "left" : a.hasClass("fr-fir") ? "right" : pa(a)), a.removeClass("fr-dib fr-dii fr-fir fr-fil")
        }
        ...
        function j(c) {
            ...
            if (Qa && c) {
                var i = [];
                for (d = 0; d < Qa.length; d++) i.push(Qa[d].getAttribute("src"));
        ...
        function ea(a) {
            ...
            d && "auto" != d && (d += b.opts.imageResizeWithPercent ? "%" : "px"),
                b.html.insert('<img data-fr-image-pasted="true" class="' + (b.opts.imageDefaultDisplay ? "fr-di" + b.opts.imageDefaultDisplay[0] : "") + (b.opts.imageDefaultAlign && "center" != b.opts.imageDefaultAlign ? " fr-fi" + b.opts.imageDefaultAlign[0] : "") + '" src="' + c + '"' + (d ? ' style="width: ' + d + ';"' : "") + ">"), b.events.trigger("paste.after")
        }
        ...
        function ja(a) {
            Da && (ma() || !0 === a) && (b.toolbar.enable(), Ea.removeClass("fr-active"), b.popups.hide("image.edit"), Da = null, la(), Fa = null, Ga && Ga.hide())
        }
        ...
        function na(a, c, d) {
            if (b.opts.imageEditButtons.indexOf("imageAlign") < 0 && b.opts.imageEditButtons.indexOf("imageDisplay") < 0) return !1;
