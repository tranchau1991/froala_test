    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        function c() {
            ...
            if (c || (c = s()), e(), !c.hasClass("fr-active"))
                if (b.popups.refresh("file.insert"), b.popups.setContainer("file.insert", b.$tb), a.is(":visible")) {
        ...
        function h(a, c, d) {
            b.edit.on(), b.events.focus(!0), b.selection.restore(), b.opts.fileUseSelectedText && b.selection.text().length && (c = b.selection.text()), b.html.insert('<a href="' + a + '" target="_blank" id="fr-inserted-file" class="fr-file">' + c + "</a>");
        ...
        function s(a) {
            ...
            var c = "";
            b.opts.fileUpload || b.opts.fileInsertButtons.splice(b.opts.fileInsertButtons.indexOf("fileUpload"), 1), c = '<div class="fr-buttons">' + b.button.buildList(b.opts.fileInsertButtons) + "</div>";
            var d = "";
        ...
        function u(c) {
            ...
            if (e && e.files && e.files.length) {
                ...
                if (f && void 0 !== f.type && f.type.indexOf("image") < 0 && (b.opts.fileAllowedTypes.indexOf(f.type) >= 0 || b.opts.fileAllowedTypes.indexOf("*") >= 0)) {
                    if (!b.opts.fileUpload) return c.preventDefault(), c.stopPropagation(), !1;
