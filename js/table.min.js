...
! function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        function x() {
            ...
            if (c.length > 0) {
                ...
                if (0 === h.min_j && h.max_j == g[0].length - 1) r();
                        ...
                        for (d = 0; d < g.length; d++)
                            if (0 === d || g[d][e] != g[d - 1][e])
                                if (f = a(g[d][e]), (parseInt(f.attr("colspan"), 10) || 1) > 1) {
                                    ...
                                    1 == k ? f.removeAttr("colspan") : f.attr("colspan", k), f.css("width", ((f.data("old-width") - la(e, g)) * j / i).toFixed(4) + "%"), f.removeData("old-width")
                                } else {
                    ...
                    B(0, g.length - 1, 0, g[0].length - 1, c), h.min_j > 0 ? b.selection.setAtEnd(g[h.min_i][h.min_j - 1]) : b.selection.setAtEnd(g[h.min_i][0]), b.selection.restore(), b.popups.hide("table.edit"), c.find("th, td").each(function() {
        ...
        function y(a, b, c) {
            var d, e, f, g, h, i = 0,
                j = J(c);
            if ((b = Math.min(b, j[0].length - 1)) > a)
                for (e = a; e <= b; e++)
                    if (!(e > a && j[0][e] == j[0][e - 1]) && (g = Math.min(parseInt(j[0][e].getAttribute("colspan"), 10) || 1, b - a + 1)) > 1 && j[0][e] == j[0][e + 1])
        ...
        function z(a, b, c) {
            var d, e, f, g, h, i = 0,
                j = J(c);
            if ((b = Math.min(b, j.length - 1)) > a)
                for (d = a; d <= b; d++)
                    if (!(d > a && j[d][0] == j[d - 1][0]) && (g = Math.min(parseInt(j[d][0].getAttribute("rowspan"), 10) || 1, b - a + 1)) > 1 && j[d][0] == j[d + 1][0])
        ...
        function C() {
            if (ta().length > 1 && (0 === b.$el.find("th.fr-selected-cell").length || 0 === b.$el.find("td.fr-selected-cell").length)) {
                ...
                i.html(m), b.selection.setAtEnd(i.get(0)), b.selection.restore(), b.toolbar.enable(), z(g.min_i, g.max_i, l);
        ...
        function F(a) {
            var c = b.$el.find(".fr-selected-cell");
            "REMOVE" != a ? c.css("background-color", b.helpers.HEXtoRGB(a)) : c.css("background-color", ""), d()
        }
        ...
        function J(b) {
            b = b || null;
            var c = [];
            return null == b && ta().length > 0 && (b = ua()), b && b.find("tr").not(b.find("table tr")).each(function(b, d) {
                var e = a(d),
                    f = 0;
        ...
        function O() {
            b.events.disableBlur(), b.selection.clear(), b.$el.addClass("fr-no-selection"), b.$el.blur(), b.events.enableBlur()
        }
        ...
        function S(c, d) {
            if (a(c).is(d)) N(), b.edit.on(), a(c).addClass("fr-selected-cell");
            else {
                O(), b.edit.off();
                var e = J(),
                    f = K(c, e),
                ...
                N(), c.classList.add("fr-cell-fixed"), d.classList.add("fr-cell-handler");
        ...
        function V(c) {
            var d = T(c);
            if (ta().length > 0 && !d && U(), !b.edit.isDisabled() || b.popups.isVisible("table.edit"))
                if (1 != c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey)(3 == c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey) && d && U();
                else if (Ba = !0, d) {
                ta().length > 0 && !c.shiftKey && U(), c.stopPropagation(), b.events.trigger("image.hideResizer"), b.events.trigger("video.hideResizer"), Aa = !0;
        ...
        function W(c) {
            if (Aa || b.$tb.is(c.target) || b.$tb.is(a(c.target).closest(b.$tb.get(0))) || (ta().length > 0 && b.toolbar.enable(), N()), !(1 != c.which || 1 == c.which && b.helpers.isMac() && c.ctrlKey)) {
                if (Ba = !1, Aa) {
                    Aa = !1;
                    T(c) || 1 != ta().length ? ta().length > 0 && (b.selection.isCollapsed() ? d() : N()) : N()
                }
                if (Ea) {
                    Ea = !1, ya.removeClass("fr-moving"), b.$el.removeClass("fr-no-selection"), b.edit.on();
                    var e = parseFloat(ya.css("left")) + b.opts.tableResizerOffset;
                    b.opts.iframe && (e -= b.$iframe.offset().left), ya.data("release-position", e), ya.removeData("max-left"), ya.removeData("max-right"), ka(c), ca()
                }
            }
        }
        ...
        function X(c) {
            if (!0 === Aa) {
                if (a(c.currentTarget).closest("table").is(ua())) {
        ...
        function aa(c) {
            ...
            if (e.length && (e = e[0], "TD" == e.tagName || "TH" == e.tagName)) {
                ...
                if (f && "TABLE" == f.tagName && (a.FE.KEYCODE.ARROW_LEFT == d || a.FE.KEYCODE.ARROW_UP == d || a.FE.KEYCODE.ARROW_RIGHT == d || a.FE.KEYCODE.ARROW_DOWN == d) && (ta().length > 0 && U(), b.browser.webkit && (a.FE.KEYCODE.ARROW_UP == d || a.FE.KEYCODE.ARROW_DOWN == d))) {
                    ...
                    var h = J(a(f)),
                        i = K(e, h);
                    return a.FE.KEYCODE.ARROW_UP == d ? $(i, f, h) : a.FE.KEYCODE.ARROW_DOWN == d && _(i, f, h), b.selection.restore(), !1
                }
            }
        }

        function ba() {
            b.shared.$table_resizer || (b.shared.$table_resizer = a('<div class="fr-table-resizer"><div></div></div>')), ya = b.shared.$table_resizer, b.events.$on(ya, "mousedown", function(a) {
            ...
            }), b.events.$on(ya, "mousemove", function(a) {
                if (!b.core.sameInstance(ya)) return !0;
                Ea && (b.opts.iframe && (a.pageX -= b.$iframe.offset().left), na(a))
            }), b.events.on("shared.destroy", function() {
                ya.html("").removeData().remove(), ya = null
            }, !0), b.events.on("destroy", function() {
                b.$el.find(".fr-selected-cell").removeClass("fr-selected-cell"), ya.hide().appendTo(a("body:first"))
            }, !0)
        }
        ...
        function fa(c, d) {
            ...
            za || qa(), b.$box.append(za), za.data("instance", b);
            var e = a(d),
                f = e.find("tr:first"),
                g = c.pageX,
                h = 0,
            ...
            if (0 === ta().length) {
                ...
                if (d && ("HTML" == d.tagName || "BODY" == d.tagName || b.node.isElement(d)))
                    for (e = 1; e <= b.opts.tableInsertHelperOffset; e++) {
                        ...
                        if (f && ("TH" == f.tagName || "TD" == f.tagName || "TABLE" == f.tagName) && (a(f).parents(".fr-wrapper").length || b.opts.iframe)) return fa(c, a(f).closest("table")), !0;
                        if (g = b.doc.elementFromPoint(c.pageX - b.win.pageXOffset + e, c.pageY - b.win.pageYOffset), a(g).hasClass("fr-tooltip")) return !0;
                        if (g && ("TH" == g.tagName || "TD" == g.tagName || "TABLE" == g.tagName) && (a(g).parents(".fr-wrapper").length || b.opts.iframe)) return ga(c, a(g).closest("table")), !0
                    }
        ...
        function na(a) {
            if (ta().length > 1 && Ba && O(), !1 === Ba && !1 === Aa && !1 === Ea) Da && clearTimeout(Da), b.edit.isDisabled() && !b.popups.isVisible("table.edit") || (Da = setTimeout(ia, 30, a));
            else if (Ea) {
        ...
        function pa(c) {
            if (c.which == a.FE.KEYCODE.TAB) {
                var d;
                if (ta().length > 0) d = b.$el.find(".fr-selected-cell:last");
                else {
        ...
        function qa() {
            b.shared.$ti_helper || (b.shared.$ti_helper = a('<div class="fr-insert-helper"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + b.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a></div>'), b.events.bindClick(b.shared.$ti_helper, "a", function() {
                ...
                "before" == c ? (b.undo.saveStep(), a.addClass("fr-selected-cell"), d.table.insertColumn(c), a.removeClass("fr-selected-cell"), b.undo.saveStep()) : "after" == c ? (b.undo.saveStep(), a.addClass("fr-selected-cell"), d.table.insertColumn(c), a.removeClass("fr-selected-cell"), b.undo.saveStep()) : "above" == c ? (b.undo.saveStep(), a.addClass("fr-selected-cell"), d.table.insertRow(c), a.removeClass("fr-selected-cell"), b.undo.saveStep()) : "below" == c && (b.undo.saveStep(), a.addClass("fr-selected-cell"), d.table.insertRow(c), a.removeClass("fr-selected-cell"), b.undo.saveStep()), da()
            }), b.events.on("shared.destroy", function() {
                ...
                da()
            }, !0)), za = b.shared.$ti_helper, b.events.on("destroy", function() {
                za = null
            }), b.tooltip.bind(b.$box, ".fr-insert-helper > a.fr-floating-btn")
        }

        function ra() {
            Ca = null, clearTimeout(Da)
        }
        ...
        function va(c) {
            if (c.altKey && c.which == a.FE.KEYCODE.SPACE) {
                ...
                if ("TD" == f.tagName || "TH" == f.tagName ? e = f : a(f).closest("td").length > 0 ? e = a(f).closest("td").get(0) : a(f).closest("th").length > 0 && (e = a(f).closest("th").get(0)), e) return c.preventDefault(), S(e, e), d(), !1
            }
        }
        ...
        function wa(c) {
            ...
            if (d.length > 0) {
                ...
                if (a.FE.KEYCODE.ARROW_RIGHT == h) {
                    if (i.col < g[0].length - 1) return S(e, g[i.row][i.col + 1]), !1
                } else if (a.FE.KEYCODE.ARROW_DOWN == h) {
                    if (i.row < g.length - 1) return S(e, g[i.row + 1][i.col]), !1
                } else if (a.FE.KEYCODE.ARROW_LEFT == h) {
                    if (i.col > 0) return S(e, g[i.row][i.col - 1]), !1
                } else if (a.FE.KEYCODE.ARROW_UP == h && i.row > 0) return S(e, g[i.row - 1][i.col]), !1
            }
        }
        ...
        function xa() {
            ...
            if (!b.helpers.isMobile()) {
                Ba = !1, Aa = !1, Ea = !1, b.events.$on(b.$el, "mousedown", V), b.popups.onShow("image.edit", function() {
                    N(), Ba = !1, Aa = !1
                }), b.popups.onShow("link.edit", function() {
                    N(), Ba = !1, Aa = !1
                }), b.events.on("commands.mousedown", function(a) {
                    a.parents(".fr-toolbar").length > 0 && N()
                }), b.events.$on(b.$el, "mouseenter", "th, td", X), b.events.$on(b.$win, "mouseup", W), b.opts.iframe && b.events.$on(a(b.o_win), "mouseup", W), b.events.$on(b.$win, "mousemove", na), b.events.$on(a(b.o_win), "scroll", ja), b.events.on("contentChanged", function() {
                    ta().length > 0 && (d(), b.$el.find("img").on("load.selected-cells", function() {
                        a(this).off("load.selected-cells"), ta().length > 0 && d()
                    }))
                }), b.events.$on(a(b.o_win), "resize", function() {
                    N()
                }), b.events.on("toolbar.esc", function() {
                    if (ta().length > 0) return b.events.disableBlur(), b.events.focus(), !1
                }, !0), b.events.$on(a(b.o_win), "keydown", function() {
                    ...
                    var d = ta();
                    if (d.length > 0) {
                        if (d.length > 0 && b.keys.ctrlKey(c) && c.which == a.FE.KEYCODE.A) return N(), b.popups.isVisible("table.edit") && b.popups.hide("table.edit"), d = [], !0;
                        if (c.which == a.FE.KEYCODE.ESC && b.popups.isVisible("table.edit")) return N(), b.popups.hide("table.edit"), c.preventDefault(), c.stopPropagation(), c.stopImmediatePropagation(), d = [], !1;
