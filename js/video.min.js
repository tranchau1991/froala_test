...
! function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        function f(a) {
            ...
            var d = "";
            b.opts.videoUpload || b.opts.videoInsertButtons.splice(b.opts.videoInsertButtons.indexOf("videoUpload"), 1), b.opts.videoInsertButtons.length > 1 && (d = '<div class="fr-buttons">' + b.button.buildList(b.opts.videoInsertButtons) + "</div>");
            var e, f = "",
        ...
        function r(c) {
            if (void 0 === c) {
                c = (b.popups.get("video.insert").find('.fr-video-by-url-layer input[type="text"]').val() || "").trim()
            }
            var d = null;
            if (/^http/.test(c) || (c = "https://" + c), b.helpers.isURL(c))
        ...
        function A(c, d, e) {
            ...
            i.toggleClass("fr-draggable", b.opts.videoMove), b.edit.on(), b.events.focus(!0), b.selection.restore(), b.undo.saveStep(), b.opts.videoSplitHTML ? b.markers.split() : b.markers.insert(), b.html.wrap();
            var j = b.$el.find(".fr-marker");
            return b.node.isLastSibling(j) && j.parent().hasClass("fr-deletable") && j.insertAfter(j.parent()), j.replaceWith(i), b.selection.clear(), i.find("video").get(0).readyState > i.find("video").get(0).HAVE_FUTURE_DATA || b.helpers.isIOS() ? e.call(i.find("video").get(0)) : i.find("video").on("canplaythrough load", e), i
        }
        ...
        function O(c) {
            ...
            if (d && d.files && d.files.length) {
                ...
                if (e && e.type && -1 !== e.type.indexOf("video")) {
                    if (!b.opts.videoUpload) return c.preventDefault(), c.stopPropagation(), !1;
        ...
        function R() {
            ...
            }), b.events.on("video.hideResizer commands.undo commands.redo element.dropped", function() {
                K(!0)
            })
        }
